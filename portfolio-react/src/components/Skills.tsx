...
const Skills = () => {
  ...
  const skills: Skill[] = [
    ...
    { name: 'React', icon: FaReact, color: 'text-cyan-500', level: 55 },
    { name: 'Vue.js', icon: FaVuejs, color: 'text-green-500', level: 30 },
    { name: 'Next.js', icon: SiNextdotjs, color: 'text-gray-800', level: 60 },
    { name: 'TypeScript', icon: SiTypescript, color: 'text-blue-600', level: 60 },
  ];

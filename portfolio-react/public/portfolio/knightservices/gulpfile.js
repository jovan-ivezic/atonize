 ...
 * Icons tasks
 */
// delete all icons from theme dir
gulp.task( 'clean:icons', function(cb) {
  return del([
    'wp-content/themes/makespace-child/icons/**'
  ], cb);
});

// build sprite and send to theme dir
gulp.task( 'icons', ['clean:icons'], function() {
  return gulp.src('wp-content/themes/makespace-child/src/icons/*.svg')
    .pipe(plumber())
    .pipe(svgmin())
    .pipe(svgSymbols({
    ...
    .pipe(gulp.dest('wp-content/themes/makespace-child/icons'))
    .pipe(livereload());
});
...
gulp.task( 'watch', function(){
	...
	gulp.watch('wp-content/themes/makespace-child/src/icons/**/*.svg', ['icons']);
...
gulp.task( 'default', [
	'sass', 'font-awesome', 'lint', 'scripts', 'icons', 'watch'
] );
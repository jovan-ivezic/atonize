...
!function(e){e(document).ready(function(){console.log("Doc ready!"),e(".menu-open, .menu-close").on("click",function(){e("html").toggleClass("menu-active")}),e(".projects-slider").length&&e(".slider").slick({infinite:!0,slidesToShow:1,arrows:!0,nextArrow:'<button type="button" class="next-arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></button>',prevArrow:'<button type="button" class="prev-arrow"><i class="fa fa-angle-left" aria-hidden="true"></i></button>',cssEase:"ease-in-out",speed:600,appendArrows:e(".arrows")}),e(".portfolio-gallery-link").length&&e(".portfolio-gallery-link").magnificPopup({type:"image",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),e(".location-map").length&&function(){var e=document.getElementById("cd-map"),a={lat:parseFloat(e.dataset.lat),lng:parseFloat(e.dataset.lng)};map=new google.maps.Map(e,{draggable:!1,mapTypeControl:!1,scrollwheel:!1,disableDefaultUI:!0,center:a,zoom:15});new google.maps.Marker({position:new google.maps.LatLng(parseFloat(e.dataset.lat),parseFloat(e.dataset.lng)),icon:MSWObject.marker_url,map:map});google.maps.event.addDomListener(window,"resize",function(){map.setCenter(a)})}()})}(jQuery);
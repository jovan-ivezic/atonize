...
?>
		...
		<footer class="site-footer">
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/logo-footer.svg" class="footer-logo" alt="knight services" />
			<nav class="footer-inlinks">
			<a class="footer-tel" href="tel:<?php echo esc_html( $contact[ 'phone_number' ] ); ?>"><?php echo esc_html( $contact[ 'phone_number' ] ); ?></a>
				<ul>

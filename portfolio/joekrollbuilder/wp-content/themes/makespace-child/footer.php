	<?php
		...
		$contact_information = get_field( 'contact_information', 'option' )[0];

	?>
		
		<footer class="site-footer">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/logo-footer.svg" alt="logo" class="footer-logo" />
			<a href="javascript:;" class="button">Client portal</a>
			<div class="social-icons">
				<?php foreach ( $contact_information[ 'social_media_links' ] as $social ) :?>

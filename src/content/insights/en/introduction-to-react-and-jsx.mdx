...
- **Hooks** (`useState`, `useEffect`, `useContext`) — ways to add logic and side effects to components → [LINK_TO_HOOKS_ARTICLE]
- **Next.js App Router** — wraps React in a full-stack framework with Server Components, routing, and data fetching → [LINK_TO_NEXTJS_INTRO_ARTICLE]
